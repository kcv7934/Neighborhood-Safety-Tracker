    ...
    .get(async (req, res) => {
        if (req.query.deleted) {
            return res.render("users/login", {
                ...
                successMessage: "Your account has been deleted successfully. Please log in or register a new account.",
            });
        }else {
            return res.render("users/login", {
                title: "Login",
...
router
    ...
    .post(async (req, res) => {
        ...
        try {
            ...
            const updatedUser = await userData.editUser(req.session.user.id, { firstName, lastName, email, age, state, city });
